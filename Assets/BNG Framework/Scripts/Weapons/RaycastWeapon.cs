...
namespace BNG
{
	...
	public class RaycastWeapon : GrabbableEvents
	{
		...
		/// </summary>
		[HideInInspector]
		public bool slideForcedBack = false;

		[HideInInspector]
		public WeaponSlide ws;
		...
		[HideInInspector]
		public bool playedEmptySound = false;
		...
		protected void updateChamberedBullet()
		{
		...
		public IEnumerator animateSlideAndEject()
		{
