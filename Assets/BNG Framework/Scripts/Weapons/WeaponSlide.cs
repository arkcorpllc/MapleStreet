...
namespace BNG {
    ...
    public class WeaponSlide : MonoBehaviour {
        ...
        public virtual void LockBack() {
            ...
            if (!LockedBack) {
                if ((thisGrabbable != null & thisGrabbable.BeingHeld) || (parentGrabbable != null & parentGrabbable.BeingHeld)) {
        ...
        public virtual void LockSlidePosition() {
            ...
            if ((parentGrabbable != null & parentGrabbable.BeingHeld) &&
				(thisGrabbable != null & !thisGrabbable.BeingHeld) && !lockSlidePosition)
			{
