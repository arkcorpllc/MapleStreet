...
namespace BNG {
    public class NetworkPlayer : MonoBehaviourPunCallbacks, IPunObservable, IPunOwnershipCallbacks {
        ...
        public void AssignPlayerObjects() {
            ...
            PlayerHeadTransform = getChildTransformByName(ThirdRealm.ThirdRealmCore.Instance.LocalPlayer, "CenterEyeAnchor");
        ...
        void requestOwnerShipForNearbyGrabbables(GrabbablesInTrigger grabbables) {
            ...
            foreach (var grab in grabbables.ValidRemoteGrabbables) {
				if (grab.Key == null || grab.Value == null || grab.Value.gameObject == null)
				{
					grabbables.RemoveNearbyGrabbable(grab.Key, grab.Value);
					return;
				}
        ...
        public void OnOwnershipRequest(PhotonView targetView, Player requestingPlayer) {
            ...
            bool amOwner = targetView.IsMine || (targetView.Owner == null && PhotonNetwork.IsMasterClient);
